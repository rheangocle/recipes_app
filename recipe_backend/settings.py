...
SOCIAL_ACCOUNT_PROVIDERS = {
    "google": {
        "APP": {
            "client_id": config("GOOGLE_OAUTH_CLIENT_ID", default="dummy-client-id"),
            "secret": config("GOOGLE_OAUTH_CLIENT_SECRET", default="dummy-secret"),
            "key": "",
        },
        "SCOPE": ["profile", "email"],
...
CACHE_MIDDLEWARE_KEY_PREFIX = 'recipes_app'